...
@endsection
@section('content')
    <section class="card" style="background: #243642;">
        <div class="card-header">
            <h3 class="card-title text-light">Masukan pertanyaan anda</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form action="/forum/store" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                 <div class="form-group">
                     <label for="judul" class="text-light">Masukan judul</label>
                    <input type="text" class="form-control  @error('judul') is-invalid @enderror" name="Judul" placeholder="masukan judul" id="judul">
                </div>
                <div class="form-group">
                        <label for="exampleInputPassword1" class="text-light">Masukan pertanyaan anda</label>
                ...
                <div class="form-group">
                    <label for="tags" class="text-light">Hashtag</label>
...
@endsection
@section('footer')
<script src="https://cdn.tiny.cloud/1/hbyromesjcxbb82n3kk0fyr98pfltx2gkc9snr30ely01z5g/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
