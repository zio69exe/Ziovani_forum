...
@section('content')
    <section class="card" style="background: #243642;">
        <div class="card-header">
            <h3 class="card-title text-light">Edit jawaban anda</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
            ...
            <div class="card-body">
                <input type="text" name="pertanyaan" value="{{$jawaban->pertanyaan->id}}" hidden>
                 <div class="form-group">
                     <label class="text-light" for="judul">Pertanyaan</label>
                ...
                <div class="form-group">
                        <label class="text-light" for="exampleInputPassword1">Masukan jawaban anda</label>
